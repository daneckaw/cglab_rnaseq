...
p1 = volcano_plot(deseq_df, DEGdf_up2x_FDR5_cf, DEGdf_down2x_FDR5_cf) +
  ggtitle("FLUC vs DMSO, Strain CBS138")
#p1
```
...
p2 = volcano_plot(deseq_df, DEGdf_up2x_FDR5_cv, DEGdf_down2x_FDR5_cv) +
  ggtitle("VORI vs DMSO, Strain CBS138")
#p2
...
p3 = volcano_plot(deseq_df, DEGdf_up2x_FDR5_cvf, DEGdf_down2x_FDR5_cvf) +
  ggtitle("VORI vs FLUC, Strain CBS138")
#p3
...
p4 = volcano_plot(deseq_df, DEGdf_up2x_FDR5_bf, DEGdf_down2x_FDR5_bf) +
  ggtitle("FLUC vs DMSO, Strain BG2")
#p4
```
...
p5 = volcano_plot(deseq_df, DEGdf_up2x_FDR5_bv, DEGdf_down2x_FDR5_bv) +
  ggtitle("VORI vs DMSO, Strain BG2")
#p5
```
...
p6 = volcano_plot(deseq_df, DEGdf_up2x_FDR5_bfv, DEGdf_down2x_FDR5_bfv) +
  ggtitle("VORI vs FLUC, Strain BG2")
# p6
```
...
- Drug vs no drug, taking average of VORI and FLUC responses
