...
head(counts_all_CBS138)

conditions_to_compare = c("CBS138_RPMI_DMSO", "CBS138_RPMI_FLUC")


dds_compared_conditions = de_seq(counts_all_CBS138,
...
dds_compared_conditions = de_seq(counts_all_CBS138, conditions_to_compare)
dds_compared_conditions
...
dds_compared_conditions = de_seq(counts_all_BG2,
                                 conditions_to_compare)
dds_compared_conditions
...
dds_compared_conditions = de_seq(counts_all_BG2, conditions_to_compare)
dds_compared_conditions
...
dds_compared_conditions <- 
  DESeqDataSetFromMatrix(countData = counts_all_joined %>%
                           dplyr::select(sample_sheet_compared_conditions$Code) %>%
                           magrittr::set_rownames(counts_all_joined$Gene),
                         colData = sample_sheet_compared_conditions,
                         design = ~ Strain) %>%
