...
```{r show_data_1}
counts_all_1 = read.table("../data/featureCounts/Candida_glabrata_CBS138/counts/all_conditions_featureCounts.tab", header=TRUE)
counts_all_2 = read.table("../data/featureCounts/Candida_glabrata_BG2/counts/all_conditions_featureCounts.tab", header=TRUE)

counts_rpm_1 = read.table("../data/featureCounts/Candida_glabrata_CBS138/counts/all_conditions_rpm.tab", header=TRUE, row.names = 1)
counts_rpm_2 = read.table("../data/featureCounts/Candida_glabrata_BG2/counts/all_conditions_rpm.tab", header=TRUE, row.names = 1)
...
samplesheet = read.csv("../data/sample_sheets/experiment_data_both.csv")
