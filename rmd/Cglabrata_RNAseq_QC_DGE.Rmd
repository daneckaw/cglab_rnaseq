...
ggpairs(data = counts_all_CBS138 %>%
          dplyr::rename_with(.fn = stringr::str_remove,
                             pattern = "CBS138_RPMI_") %>%
          dplyr::select(all_of(shortcodes)) %>%
          dplyr::rename_with(.fn = stringr::str_replace_all,
                             pattern = c("DMSO" = "CT",
                                         "FLUC" = "FCZ",
                                         "VORI" = "VCZ")) %>%
          magrittr::add(1) %>%
...
ggsave("../figures/logcountcorrelations_CBS138.png",
       width = 9, height = 9)
...
ggsave("../figures/logcountcorrelations_BG2.png",
       width = 9, height = 9)
...
## Figure 4 - Azole drugs induce differential expression of specific genetic pathways.
